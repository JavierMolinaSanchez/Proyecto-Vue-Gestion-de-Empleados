  ...
  <div class="form-container">
    ...
    <form @submit.prevent="agregarEmpleado">
      <div>
        ...
        <input type="text" id="nombre" v-model="nombre" required @input="validarNombre" />
      ...
      <div>
        ...
        <input type="number" id="salario" v-model.number="salario" required step="0.01" min="1" />
      </div>
      <div>
...
export default {
  ...
  methods: {
    validarNombre() {
      this.nombreValido = this.nombre.trim() !== '' && /^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]+$/.test(this.nombre)
